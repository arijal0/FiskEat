  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-blue-700/70 dark:from-blue-950/90 dark:to-blue-900/70"></div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                ...
                className="inline-flex items-center gap-3 bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors shadow-lg hover:shadow-xl"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Live Menus</h3>
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Nutrition Info</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">AI Advice</h3>
              <p className="text-gray-600 dark:text-gray-300">
